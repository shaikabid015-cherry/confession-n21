...
// This handles login functionality
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    { id: 'N211106', password: '@44f7f@', name: 'PUTTU KAVYA', email: 'n211106@rguktn.ac.in', profilePic: 'https://intranet.rguktn.ac.in/SMS/usrphotos/user/N211106.jpg' }
        ...
        if (!localStorage.getItem('confessionUsers')) {
            localStorage.setItem('confessionUsers', JSON.stringify(users));
        }
    };
    ...
    if (loginForm) {
        loginForm.addEventListener('submit', function(e) {
            ...
            // Validate ID format (N followed by 6 digits)
            const idPattern = /^N\d{6}$/;
            if (!idPattern.test(userId)) {
                showError('Invalid ID format. Please use N followed by 6 digits (e.g., N210001).');
                return;
            }
            ...
            if (user) {
                ...
                // Redirect based on the original intent
                setTimeout(() => {
                    if (redirect === 'messages') {
                        window.location.href = 'messages.html';
                    } else if (redirect === 'confess') {
                        window.location.href = 'confess.html?type=viaId';
                    } else {
                        window.location.href = 'messages.html';
                    }
                }, 1500);
    ...
    function showSuccess(message) {
        ...
        let successMsg = document.getElementById('login-success');
        if (!successMsg) {
            successMsg = document.createElement('div');
            successMsg.id = 'login-success';
            successMsg.className = 'success-message';
            successMsg.innerHTML = '<i class="fas fa-check-circle"></i><span></span>';
